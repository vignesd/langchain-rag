# IT Help Knowledge Base

Each section is a standalone document optimized for semantic retrieval using OpenAI embeddings.
...
- Source: IT Help Knowledge Base
- Document ID: KI-00001
...
Q: How do I set up my company email on my mobile device?
...
company, device, email, for, how, mobile, set, setting
...
Q: I forgot my PIN, how can I reset it?


## Reference Answer

Don't worry, I'm here to help To reset your forgotten PIN, you can use our self-service PIN Reset Tool. Here are the steps to follow:
...
can, forgot, forgotten, how, pin, pin,, reset, resetting
...
## Metadata
- Topic: Configuring VPN Access for Remote Workers
- Source: IT Help Knowledge Base
- Document ID: KI-00003
...
Q: How do I set up VPN access on my laptop so I can work from home and access company resources?


## Reference Answer

To set up VPN access on your laptop and access company resources from home, follow these steps:
...
access, and, can, company, configuring, for, from, home, how, laptop, remote, resources, set, vpn, work, workers
...
## Metadata
- Topic: Troubleshooting Issues with Microsoft Office
- Source: IT Help Knowledge Base
- Document ID: KI-00004
...
Q: My Microsoft Word keeps freezing every time I try to open a document, I've tried closing and reopening it but the issue persists, what can I do to fix it?


## Reference Answer

I'd be happy to help you troubleshoot the issue with Microsoft Word.
...
By following these steps, you should be able to troubleshoot and resolve common issues with Microsoft Office applications. If the issue persists, contact the IT department for further assistance.


## Search Keywords

and, but, can, closing, document,, every, fix, freezing, i've, issue, issues, keeps, microsoft, office, open, persists,, reopening, the, time, tried, troubleshooting, try, what, with, word


---

# Setting Up a Conference Call on Cisco Webex

## Metadata
- Topic: Setting Up a Conference Call on Cisco Webex
- Source: IT Help Knowledge Base
- Document ID: KI-00005
...
Q: How do I set up a conference call on Cisco Webex with both video and audio for a meeting with multiple participants?


## Reference Answer

To set up a conference call on Cisco Webex with both video and audio for a meeting with multiple participants, follow these steps:
...
To set up a conference call on Cisco Webex, follow these steps:
...
By following these steps, you can successfully set up and host a conference call on Cisco Webex. If you have any further questions or issues, please contact the IT helpdesk for assistance.


## Search Keywords

and, audio, both, call, cisco, conference, for, how, meeting, multiple, participants, set, setting, video, webex, with
...
## Metadata
- Topic: Creating a Backup of Important Files
- Source: IT Help Knowledge Base
- Document ID: KI-00006
...
Q: How do I back up my important work files to prevent data loss?


## Reference Answer

To back up your important work files, follow these steps:
...
By following these steps, you can ensure that your important files are safely backed up and protected from loss or corruption.


## Search Keywords

back, backup, creating, data, files, how, important, loss, prevent, work
...
## Metadata
- Topic: Troubleshooting Issues with Company-Issued Tablets
- Source: IT Help Knowledge Base
- Document ID: KI-00007
...
Q: My company-issued tablet is freezing frequently and I'm unable to access some of my apps, what can I do to fix the issue?


## Reference Answer

I'd be happy to help you troubleshoot the issue with your company-issued tablet!
...
If none of the above steps resolve the issue, please escalate the issue to advanced support, providing as much detail as possible about the problem and the steps taken so far.


## Search Keywords

access, and, apps,, can, company, company-issued, fix, freezing, frequently, i'm, issue, issued, issues, some, tablet, tablets, the, troubleshooting, unable, what, with
...
## Metadata
- Topic: Setting Up a Secure Wireless Network
- Source: IT Help Knowledge Base
- Document ID: KI-00008
...
Q: How do I set up a secure wireless network for my workgroup to prevent unauthorized access and ensure data protection?


## Reference Answer

To set up a secure wireless network for your workgroup, follow these steps:
...
access, and, data, ensure, for, how, network, prevent, protection, secure, set, setting, unauthorized, wireless, workgroup
...
## Metadata
- Topic: Resetting a Jammed Printer
- Source: IT Help Knowledge Base
- Document ID: KI-00009
...
Q: What steps can I take to fix my printer when it's jammed and won't print?


## Reference Answer

Don't worry, I'm here to help To fix a jammed printer, follow these steps:
...
and, can, fix, it's, jammed, print, printer, resetting, steps, take, what, when, won't
...
## Metadata
- Topic: Configuring Email on an Android Device
- Source: IT Help Knowledge Base
- Document ID: KI-00010


## User Intent

How do I set up my company email on my personal Android device?


## Canonical Question

Q: How do I set up my company email on my personal Android device?


## Reference Answer

To set up your company email on your personal Android device, follow these steps:
...
android, company, configuring, device, email, how, personal, set
